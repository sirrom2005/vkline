...
<head>
    ...
    <![endif]-->
    <link href="catalog/view/theme/theme638/stylesheet/stylesheet.css" rel="stylesheet">
</head>
<style>
.newsletter-error,.newsletter-success{ position:relative; margin-top:-30px;}
.ltext{font-family: "Vidaloka",serif; text-align:center; font-size:18px}
</style>
<body>
<div class="container">
    <div class="row" style="padding-bottom:15px;">
        <div class="col-lg-12">
            <img src="catalog/view/theme/theme638/image/COMINGSOON.jpg" />
        </div>
    </div>
	<h3 class="ltext">Stay tuned Gaza Family the Big reveal soon forward....</h3>
